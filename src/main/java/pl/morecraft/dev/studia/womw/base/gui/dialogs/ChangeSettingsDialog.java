...
public class ChangeSettingsDialog extends JDialog {
    ...
    public ChangeSettingsDialog(final Frame parent) {
        ...
        this.setTitle(Translator.getString("SETTINGS"));

        this.colors = new JPanel();
        this.colors.setBounds(0, 0, 300, 116);
        this.colors.setBorder(BorderFactory.createTitledBorder(null, Translator.getString("SETTINGS_COLORS"),
        ...
        this.lsc = new String[]{
                Translator.getString("SETTINGS_CONDUCTOR"),
                Translator.getString("SETTINGS_HEAD"),
                Translator.getString("SETTINGS_TAIL"),
                Translator.getString("SETTINGS_BACKGROUND")};
        ...
        this.p2.setBorder(BorderFactory
                .createTitledBorder(null, Translator.getString("SETTINGS_SCALE"),
                        TitledBorder.CENTER, TitledBorder.TOP, new Font("Tahoma", Font.BOLD, 11)));
        ...
        this.jss.addChangeListener(arg0 -> ChangeSettingsDialog.this.l1a.setText(
                ChangeSettingsDialog.this.jss.getValue() + ""));

        this.p3 = new JPanel();
        this.p3.setBounds(0, 172, 300, 67);
        this.p3.setBorder(BorderFactory.createTitledBorder(null, Translator.getString("SETTINGS_AUTOSAVE"),
                TitledBorder.CENTER, TitledBorder.TOP, new Font("Tahoma", Font.BOLD, 11)));
        this.p3.setLayout(null);

        this.jch1 = new JCheckBox("<html>" + Translator.getString("SETTINGS_AUTOSAVE_TEXT") + "</html>");
        ...
        this.bA.addActionListener(arg0 -> {
                    int n = JOptionPane.showConfirmDialog(
                            ChangeSettingsDialog.this.getParent(),
                            Translator.getString("SETTINGS_SAVE_NOW"),
                            Translator.getString("QUESTION"),
                    ...
                    if (n == 0 || Configuration.AUTOSAVE) {
                        ...
                        if (!Configuration.AUTOSAVE)
                            JOptionPane.showMessageDialog(
                                    ChangeSettingsDialog.this.getParent(),
                                    Translator.getString("SAVED"),
                                    Translator.getString("INFORMATION"),
                                    JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(
                                ChangeSettingsDialog.this.getParent(),
                                Translator.getString("SETTINGS_MIS_AFTER_RERUN"),
                                Translator.getString("INFORMATION"),
                                JOptionPane.INFORMATION_MESSAGE);
                    }
