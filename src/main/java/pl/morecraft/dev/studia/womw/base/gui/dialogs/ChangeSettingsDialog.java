...
public class ChangeSettingsDialog extends JDialog {
    ...
    public ChangeSettingsDialog(final Frame parent) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            this.llc[i].setBounds(50, 20 + i * 20, 80, 20);
        ...
        this.p3.setBorder(BorderFactory.createTitledBorder(null, "AUTOZAPIS USTAWIE�", TitledBorder.CENTER, TitledBorder.TOP, new Font("Tahoma",
                Font.BOLD, 11)));
        ...
        this.jch1.setFont(new Font("Arial", Font.PLAIN, 10));
        this.jch1.setBounds(20, 20, 270, 30);
        ...
        this.bA.setBounds(0, 244, 300, 30);
        this.bA.addActionListener(arg0 -> {
                    int n = JOptionPane.showConfirmDialog(ChangeSettingsDialog.this.getParent(),
                            "Czy chcesz zapisaś konfigurację teraz? Zostanie zapisana w folderze z programem.", "Pytanie", JOptionPane.YES_NO_OPTION,
